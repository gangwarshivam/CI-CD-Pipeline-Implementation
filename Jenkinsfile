        ...
        stage("buildImage"){
            steps{
                script{
                    ...
                    echo "Tagging built images for push...."
                    sh "docker tag ${PROJECT_NAME}_backend ${DOCKER_IMAGE_TAG}-backend"
                    sh "docker tag ${PROJECT_NAME}_frontend ${DOCKER_IMAGE_TAG}-frontend"
                }
            }
        }
            ...
            steps{
                script{
                    ...
                    withCredentials([usernamePassword(credentialsId: 'docker-login', passwordVariable: 'PASS', usernameVariable: 'USER')]){
                        ...
                        sh "docker push ${DOCKER_IMAGE_TAG}-backend"
                        sh "docker push ${DOCKER_IMAGE_TAG}-frontend"
                    }
                }
            }
        }
